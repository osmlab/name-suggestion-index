...
export class Matcher {
  ...
  buildMatchIndex(data) {
    return this.matchIndexPromise || (this.matchIndexPromise = this._buildMatchIndex(data));
  }
  ...
  buildLocationIndex(data, loco) {
    return this.locationIndexPromise ||
      (this.locationIndexPromise = this._buildLocationIndex(data, loco));
  }
  ...
  async _buildLocationIndex(data, loco) {
    ...
    while (categories.length) {
      let tkv = categories.pop();
console.time(tkv);
      await new Promise(r => r(_indexCategory(tkv)));
console.timeEnd(tkv);
    }
