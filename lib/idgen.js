...
export function idgen(item, tkv, locationID) {
  ...
  let osmtags;
  if (t === 'transit') {
    osmtags = ['name', 'name:en', 'name:sr-Latn', 'network', 'network:en', 'network:sr-Latn', 'operator', 'operator:en', 'operator:sr-Latn', 'brand', 'brand:en', 'brand:sr-Latn'];
  } else if (t === 'operators') {
    osmtags = ['operator', 'operator:en', 'operator:sr-Latn', 'name', 'name:en', 'name:sr-Latn', 'brand', 'brand:en', 'brand:sr-Latn', 'network', 'network:en', 'network:sr-Latn'];
  } else if (t === 'flags') {
    osmtags = ['flag:name', 'subject'];
  } else {  // brands
    osmtags = ['name', 'name:en', 'name:sr-Latn', 'brand', 'brand:en', 'brand:sr-Latn', 'operator', 'operator:en', 'operator:sr-Latn', 'network', 'network:en', 'network:sr-Latn'];
  }
