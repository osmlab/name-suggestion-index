...
export function CategoryRowSocialLinks(props) {
  ...
  if (props.facebook) {
    ...
    items.push(
      <a key='facebook' target='_blank' href={href}>
  ...
  if (props.twitter) {
    ...
    items.push(
      <a key='twitter' target='_blank' href={href}>
  ...
  if (props.instagram) {
    ...
    items.push(
      <a key='instagram' target='_blank' href={href}>
  ...
  if (props.threads) {
    ...
    items.push(
      <a key='threads' target='_blank' href={href}>
        <FontAwesomeIcon icon={faSquareThreads} size='lg' />
      </a>
    );
  }
  if (props.tiktok) {
    ...
    items.push(
      <a key='tiktok' target='_blank' href={href}>
  ...
  if (props.pinterest) {
    ...
    items.push(
      <a key='pinterest' target='_blank' href={href}>
  ...
  if (props.youtube || props.youtubeHandle) {
    ...
    items.push(
      <a key='youtube' target='_blank' href={href}>
  ...
  if (props.vk) {
    ...
    items.push(
      <a key='vk' target='_blank' href={href}>
  ...
  if (props.weibo) {
    ...
    items.push(
      <a key='weibo' target='_blank' href={href}>
  ...
  if (props.weixin) {
    ...
    items.push(
      <a key='weixin' target='_blank' href={href}>
  ...
  if (props.snapchat) {
    ...
    items.push(
      <a key='snapchat' target='_blank' href={href}>
        <FontAwesomeIcon icon={faSnapchatSquare} size='lg' />
      </a>
    );
  }
  if (props.linkedin) {
    ...
    items.push(
      <a key='linkedin' target='_blank' href={href}>
        <FontAwesomeIcon icon={faLinkedin} size='lg' />
      </a>
    );
  }

  return !!items.length && <div className='sociallinks'>{items}</div>;
}
